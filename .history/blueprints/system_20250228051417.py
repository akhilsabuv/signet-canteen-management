...
def edit_canteen_timings():
    ...
    if request.method == 'POST':
        try:
            # Debug print
            print("Received form data:", request.form.to_dict(flat=False))
            ...
            print(f"Processing canteen indices: {canteen_indices}")  # Debug print
            ...
            for index in canteen_indices:
                ...
                print(f"Shifts for canteen {canteen_name}: {shift_values}")  # Debug print
                ...
                if canteen_name and start_time and end_time:
                    ...
                    print(f"Inserted canteen timing {canteen_name} with ID {timing_id}")
                    
                    # Insert shift relationships
                    for shift_id in shift_values:
                        print(f"Inserting shift {shift_id} for timing {timing_id}")
                        cursor.execute("""
