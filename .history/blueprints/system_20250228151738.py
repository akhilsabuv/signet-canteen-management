...
def edit_canteen_timings():
    ...
    try:
        if request.method == 'POST':
            ...
            # Print all form keys and values
            print("\n1. Raw Form Data:")
            for key, value in form_data.items():
                print(f"{key}: {value}")

            # Get and print array form fields
            ...
            try:
                ...
                print(f"Existing timings in DB: {existing_timings}")
                ...
                for i in range(len(canteen_names)):
                    ...
                    print(f"  Shifts: {selected_shifts}")
