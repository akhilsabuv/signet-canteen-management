...
def edit_canteen_timings():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            for canteen_name, start_time, end_time, description, id in zip(canteen_names, start_times, end_times, descriptions, ids):
                if canteen_name and start_time and end_time:
            #         cursor.execute(""" 
            #         UPDATE canteen_timings 
            #         SET canteen_name = ?,start_time = ?, end_time = ?, description = ? 
            #         WHERE id = ? 
            #         """, (canteen_name, start_time, end_time, description, id))
            # conn.commit()
