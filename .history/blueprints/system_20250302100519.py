...
def edit_canteen_timings():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            for canteen_name, start_time, end_time, description in zip(canteen_names, start_times, end_times, descriptions):
            ...
            # for key in request.form:
            #     canteen_names = key.getlist('canteen_name')
            #     start_times = key.getlist('start_time')
            #     end_times = key.getlist('end_time')
            #     descriptions = key.getlist('description')
                # print(request.form)
