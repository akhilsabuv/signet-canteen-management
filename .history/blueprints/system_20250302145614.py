...
def assign_canteen_to_shift():
    ...
    if request.method == 'POST':
        try:
            ...
            print(form_data)  # Replace with your processing logic
            
            # After processing, redirect to avoid form re-submission
            ...
            # Optionally, you can render the same page with error message
            return redirect(url_for('system.assign_canteen_to_shift'))
