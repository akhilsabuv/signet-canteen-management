...
def ensure_system_tables():
    ...
    try:
        ...
        # Then create the junction table with proper foreign key constraints
        cursor.execute("""
            ...
            BEGIN
                CREATE TABLE canteen_timing_shifts (
                    ...
                    CONSTRAINT FK_cts_canteen_timing FOREIGN KEY (canteen_timing_id) 
                        REFERENCES canteen_timings(id) ON DELETE CASCADE,
                    CONSTRAINT FK_cts_shift FOREIGN KEY (shift_id) 
        ...
        conn.commit()
        print("System tables ensured with proper constraints.")
