...
def edit_canteen_timings():
    ...
    if request.method == 'POST':
        ...
        print("FORM GETLIST shift_1:", request.form.getlist('shift_1'))
        print("FORM GETLIST shift_2:", request.form.getlist('shift_2'))
        print("FORM GETLIST shift_3:", request.form.getlist('shift_3'))
        print("FORM GETLIST shift_4:", request.form.getlist('shift_4'))
        print("FORM GETLIST shift_5:", request.form.getlist('shift_5'))
