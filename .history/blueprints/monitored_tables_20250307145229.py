...
def check_elegibility(event_dt, devuid, usrid):
    ...
    #         # Dynamic time window check
            ...
            if start_time <= currentTime <= end_time:
                ...
                print("type of shift_start_time:",type(shift_start_time), "type of latest_start_time:",type(latest_entry),"type of latest_end_time:",type(latest_end.time()))

                event_dt = event_dt.replace(tzinfo=timezone.utc) 
                latest_entry = latest_entry.replace(tzinfo=timezone.utc) 
                print(event_dt,latest_entry)
                time_difference = abs(latest_entry-event_dt)
