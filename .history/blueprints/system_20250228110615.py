    ...
    if request.method == 'POST':
        try:
            ...
            for i in range(len(canteen_names)):
                ...
                print(f"Selected shifts for {canteen_name}: {selected_shifts}")
                ...
                if canteen_name in existing_timings:
                    ...
                    print(f"Cleared existing shifts for timing {timing_id}")
                    ...
                    processed_timing_ids.add(timing_id)
                    print(f"Created new timing with ID {timing_id}")
            ...
            for timing_id in timing_ids_to_delete:
                ...
                print(f"Deleted timing {timing_id}")
