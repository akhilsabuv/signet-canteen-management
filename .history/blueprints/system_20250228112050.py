...
def edit_canteen_timings():
    ...
    if request.method == 'POST':
        try:
            ...
            print("Form Data:", canteen_names, start_times, end_times, descriptions)  # Debug print
            ...
            for i in range(len(canteen_names)):
                ...
                print(f"Processing Timing: {canteen_name}, Start: {start_time}, End: {end_time}, Desc: {description}")  # Debug print
