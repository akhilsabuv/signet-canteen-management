    ...
    if request.method == 'POST':
        try:
            ...
            for i in range(len(canteen_names)):
                ...
                print(f"Selected shifts for timing {timing_id}: {selected_shifts}")  # Debug print
                ...
                for shift_id in selected_shifts:
                    try:
                        ...
                        print(f"Inserted relationship: timing={timing_id}, shift={shift_id}")  # Debug print
                    except Exception as e:
                        print(f"Error inserting shift relationship: {str(e)}")  # Debug print
                        raise
            ...
            print(f"Verification counts - Timings: {timing_count}, Relationships: {relationship_count}")  # Debug print
