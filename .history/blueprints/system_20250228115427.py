    ...
    try:
        ...
        if request.method == 'POST':
            try:
                ...
                print("Form data:", dict(request.form))  # Debug print
                ...
                for i in range(len(canteen_names)):
                    ...
                    # Modified: Get shifts for this timing from form
        ...
        # Get all timings with their details (for both GET and failed POST)
        cursor.execute("""
            SELECT 
                ct.id,
                ct.canteen_name,
        ...
        print("Retrieved timings:", [(t.id, t.canteen_name) for t in timings])  # Debug print
