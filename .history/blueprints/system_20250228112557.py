...
def edit_canteen_timings():
    ...
    if request.method == 'POST':
        try:
            ...
            print("Form Data:", canteen_names, start_times, end_times, descriptions)
            ...
            for i in range(len(canteen_names)):
                ...
                # Debug print for each timing being processed
                print(f"Processing Timing: {canteen_name}, Start: {start_time}, End: {end_time}, Desc: {description}")
                ...
                if canteen_name in existing_timings:
                    ...
                    # Clear existing shifts for this timing
        ...
        try:
            ...
            # Prepare a list to hold timing data with shifts
            timing_data = []
            ...
            for timing in timings:
                ...
                timing_data.append({
                    ...
                    'shifts': shifts  # Store shifts in the dictionary
                })

            print("Timing Data:", timing_data)  # Debug print to check the timing data

            return render_template('edit_canteen_timings.html', 
                                   timings=timing_data,  # Pass the new list of dictionaries
