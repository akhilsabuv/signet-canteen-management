    ...
    if request.method == 'POST':
        try:
            ...
            for i in range(len(canteen_names)):
                ...
                # Changed how we get shifts from the form
                shift_keys = [k for k in request.form.keys() if k.startswith(f'shifts_{i}')]
                selected_shifts = [request.form[k] for k in shift_keys]
