...
def check_elegibility(event_dt, devuid, usrid):
    ...
    #         # Dynamic time window check
            ...
            if start_time <= currentTime <= end_time:
                ...
                print("shift_start_time:",shift_start_time, "latest_start_time:",latest_start,"latest_end_time:",latest_end)
                print(latest_start.time())
                print("type of shift_start_time:",type(shift_start_time), "type of latest_start_time:",type(latest_start),"type of latest_end_time:",type(latest_end))


                shift_start_datetime = datetime.datetime.combine(latest_start.date(), datetime.datetime.strptime(shift_start_time, "%H:%M:%S").time())
