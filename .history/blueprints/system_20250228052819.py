        ...
        try:
            ...
            for key in request.form:
                if key.startswith('canteen_name_'):
                    ...
                    # Get and process shifts for this timing
                    shifts = request.form.getlist(f'shift_{index}')
                    print(f"Shifts for timing {timing_id}: {shifts}")
                    
                    for shift_id in shifts:
                        print(f"Inserting shift relationship: timing_id={timing_id}, shift_id={shift_id}")
                        cursor.execute("""
